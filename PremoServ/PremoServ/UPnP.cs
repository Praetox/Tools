...
namespace PremoServ
{
    public class UPnP
    {
        ...
        public static void OpenFirewallPort(int port)
        {
            ...
            foreach (System.Net.NetworkInformation.NetworkInterface nic in nics)
            {
                try
                {
                    ...
                    foreach (System.Net.NetworkInformation.GatewayIPAddressInformation gwInfo in
        ...
        public static void OpenFirewallPort(string machineIP, string firewallIP, int openPort)
        {
            ...
            openPortFromService(svc, "urn:schemas-upnp-org:service:WANIPConnection:1",
                                machineIP, firewallIP, 80, openPort);
            openPortFromService(svc, "urn:schemas-upnp-org:service:WANPPPConnection:1",
                                machineIP, firewallIP, 80, openPort);
        }
